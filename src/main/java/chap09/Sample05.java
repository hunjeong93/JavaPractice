...
abstract interface ICompute{ //인터페이스임을 구분하기 위해 'I'르 붙였고 abstract 는 생략 가능
	
	float pyung = 3.3f; //인터페이스의 멤버 변수는 static final로 컴파일 됨
	float compute(int area); //abstract int compute(int area); 추상 메서드로 처리됨
}